...
for i, (remain_index, test_index) in enumerate(outer_kf.split(data)):
    for lr, learner, embedding_size, weight_decay, epoch, train_batch_size in tqdm.tqdm(product(learning_rate, learners, embedding_sizes, weight_decays, epochs, train_batch_sizes)):
